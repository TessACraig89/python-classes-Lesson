...
Any method that looks like `__init__` or `__str__` with underscores is a **built in** function. It is not uncommon in python to customize built in functions -- but this should be done with caution! 
